...
class TestOracleSpecificTypeRendering:
    @pytest.mark.parametrize("factory,expected", [
        ...
        (lambda: OracleVarChar2Type(64), "VARCHAR2(64)"),
        (lambda: OracleVarChar2Type(None), "VARCHAR2(4000)"),
        (lambda: OracleNVarChar2Type(30), "NVARCHAR2(30)"),
        (lambda: OracleNVarChar2Type(None), "NVARCHAR2(2000)"),
        (lambda: OracleCharType(2), "CHAR(2)"),
        ...
        (lambda: OracleRawType(16), "RAW(16)"),
