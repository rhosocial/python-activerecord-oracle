# tests/rhosocial/activerecord_oracle_test/feature/query/connection/test_set_operation_context.py
"""
Bridge file for test_set_operation_context tests from the testsuite.
"""
