# tests/rhosocial/activerecord_oracle_test/feature/query/connection/test_cte_query_context.py
"""
Bridge file for test_cte_query_context tests from the testsuite.
"""
