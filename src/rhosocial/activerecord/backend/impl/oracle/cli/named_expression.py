# src/rhosocial/activerecord/backend/impl/oracle/cli/named_expression.py
...
def create_parser(subparsers):
    ...
    parser.add_argument(
        "--dialect-version",
        default=None,
        help="Oracle dialect version for capability probing (e.g., 23.0.0, 21.0.0).",
    )
    return parser
...
def handle(args):
    ...
    def create_dialect():
        return OracleDialect(version=_get_requested_version())
